...
const Chess = () => {
    ...
    // избавиться от рекурсии || переписать все на функциональных компонентах
    // todo условия для шаха и мата
    // проигрыш по истечению таймера
    // сделать кнопку для запуска иры вручную
    // todo перенести изображения в базу данных
    // todo превразать пешку в любую фигуру при достижении конца поля
